...
form(class:"form-horizontal", role:"form", method:method, action:action) {
    div(class: "form-group") {
        ...
        div(column) {
            input (inputText('isbn', isbn, [disabled: buttonText == 'Update' || buttonText == ''])) {}
        }
    }
    ...
    div(formGroup) {
        ...
        div(column) {
            input(inputText('quantity', quantity, [disabled: buttonText == '']))
        }
    }
    div(formGroup) {
        label(controlLabel('price'), 'Price')
        div(column) {
            input(inputText('price', price, [disabled: buttonText == '']))
        }
    }
    div(formGroup) {
        div(columnOffset) {
